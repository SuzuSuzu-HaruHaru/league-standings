...
The away goals rule is a famous one that made the news back in 2021, when UEFA did away with it; but is it *really* gone from the list of criteria? or again, [Group H at the 2018 FIFA World Cup](https://en.wikipedia.org/wiki/2018_FIFA_World_Cup) ended in a breathtaking way when Japan and Senegal finished their group with four points each, only to be separated by fair play points of all things; and who can say what happens at the EUROs, should two teams finish their group with exactly the same points, goal difference and goals scored, *and* they meet on the last matchday *and* their game ends in a draw? At the cost of sounding cliché, the answer might shock you.
